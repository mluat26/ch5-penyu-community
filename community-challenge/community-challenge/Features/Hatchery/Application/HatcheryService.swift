...
struct HatcheryService: Sendable {
    ...
    func createHatchery(_ input: CreateHatcheryInput) async throws -> Hatchery {
    ...
    private func makeSections(
        hatchery: Hatchery,
        nests: [Nest],
        latestReadingByNestID: [UUID: HeatReading]
    ...
    private func averageTemperature(in readings: [HeatReading]) -> Double? {
